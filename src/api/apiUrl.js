...
const {
  ...
  module: {
    ...
    addLoanApply: `${root}merchant/loanApply/addLoanApply.do`, //借款产品配置信息接口---商户贷
    ...
    getContractList: `${root}loanContract/getContractList.do`, // 签约成功后获取合同
    ...
    chackAccount: `${root}password/savePassword.do`, // 设置支付密码接口
    ...
    chooseProdcut: `${root}merchant/product/chooseProdcut.do`, // 选择借款产品
    ...
    faceID: `${root}authenticationFace/faceID.do`,
    isPass: `${root}authenticationFace/isPass.do`,
    getToken: `${root}authenticationFace/faceID/App/getToken.do`,
    doAuth: `${root}authenticationFace/faceID/App/doAuth.do`,
